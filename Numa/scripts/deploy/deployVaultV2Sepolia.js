...
async function deployVaultV2 () {
   ...
   // await numaMinter.waitForDeployment();
    ...
    tx = await numa.grantRole(roleMinter, NUMAMINTER_ADDRESS);
    ...
    fs.writeFileSync("outputSepolia.json", JSON.stringify(data, null, 2));
    console.log("contracts addresses saved to outputSepolia.json");
